...
>
  {json.data.formations.slice(0,6).map(data => (
    <Formation formation={data} />
  ))}
</Carousel>;
<div className="flex items-center justify-end">
 <Button className="font-lora" rightIcon={<ArrowCircleRightIcon className="h-6 w-6"/>} colorScheme="pink" >voir toutes les services offertes</Button>
</div>
</section>
...
<section className="container mx-auto px-10 my-10">
  ...
  itemClass="carousel-item-padding-40-px"
>
  {json.data.formations.slice(6,12).map(data => (
    <Formation formation={data} />
  ))}
</Carousel>;
<div className="flex items-center justify-end">
...
<section className="relative py-20 overflow-hidden bg-white font-lora">
    <span className="absolute top-0 right-0 flex flex-col items-end mt-0 -mr-16 opacity-60">
        <span className="container hidden w-screen h-32 max-w-xs mt-20 transform rounded-full rounded-r-none md:block md:max-w-xs lg:max-w-lg 2xl:max-w-3xl bg-pink-300"></span>
    </span>

    <span className="absolute bottom-0 left-0"> </span>

    <div className="relative px-16 mx-auto max-w-7xl">
        <p className="font-bold text-3xl tracking-wide text-blue-500 uppercase">Notre Equipe</p>
        ...
        <div className="grid w-full grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-4">
            ...
            <div className="flex flex-col items-center justify-center col-span-1">
                <div className="relative p-5">
                    <div className="absolute z-10 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-blue-50"></div>
                    <img className="relative z-20 w-full rounded-full" src="https://cdn.devdojo.com/images/june2021/avt-08.jpg" alt="momo" />
                </div>
                <div className="mt-3 space-y-2 text-center">
                    <div className="space-y-1 text-lg font-medium leading-6">
                        <h3>Alexis Jordan</h3>
...
<section className="bg-white font-lora">
    <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p className="mt-8 text-base leading-6 text-center text-gray-400">
            © 2021 kari's beauty center, All rights reserved.
        </p>
    </div>
</section>
