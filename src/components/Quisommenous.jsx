...
function Quisommenous() {
    return (
        <div>
<section className="flex items-center justify-center py-10 text-white bg-white sm:py-16 md:py-24 lg:py-32 font-lora">
    <div className="relative max-w-3xl px-10 text-center text-white auto lg:px-0">
        <div className="flex flex-col w-full md:flex-row">
            <div className="flex justify-between">
                <h1 className="relative flex flex-col text-6xl font-extrabold text-left text-pink-700">
                    QUI
                    <span>SOMMES</span>
                    <span>NOUS ?</span>
                </h1>
            ...
            <div className="relative top-0 right-0 h-64 mt-12 md:-mt-16 md:absolute md:h-96">
                <img src="team1.jpeg" className="object-cover mt-3 mr-5 h-80 lg:h-96" alt="qui sommes-nous ?" />
            </div>
        </div>

        <div className="my-16 border-b border-gray-300 lg:my-24"></div>
        <h2 className="text-left text-gray-700 xl:text-xl">
...
Notre centre vous accueille dans un cadre zen et discret de manière à y retrouver une relaxation extrême, ainsi que des outils de travail vous permettant d’acquérir toutes les connaissances dans le milieu de la beauté et du bien-être.
CK ESTHETIK se veut un centre  d’excellence au service de sa clientèle, c’est dans cette optique qu’il vous propose une gamme très variée de formation et de de soins  pour un public masculin et féminin.
Parce que certaines personnes souhaitent découvrir de nouveaux horizons ou redonner une nouvelle orientation à leur vie professionnelle, notre espace est également ouvert aux particuliers.
A la recherche constante de l’excellence, et de nouvelles tendances, dans le domaine de l’esthétique, notre Centre innove par ces formations en management vous permettant ainsi d’acquérir les clés de la réussite
        </h2>
        <ul>
            ...
            <li className="flex items-center py-2 space-x-4 xl:py-3">
              ...
              <span className="font-medium text-gray-800">Gestion , ventes conseils</span>
            </li>
          </ul>
    </div>
</section>
