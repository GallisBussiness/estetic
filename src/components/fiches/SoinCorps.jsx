            ...
            PLAN DE FORMATION MASSAGE 
              ...
              <div className="my-3 py-3">
                   ...
                   <ul className="pl-10">
                       ...
                       <li> - Les différentes appellations</li>
              ...
              <div className="my-3 py-3">
                   ...
                   <h1 className="text-2xl font-semibold my-1 pl-4">9H00 A 13H00</h1>
                   <ul className="pl-10">
                       <li> - Pratique Jambes arrières/dos</li>
                       <li> - Finitions du massage</li>
                       <li> - Séance de questions /réponses</li>
                   </ul>
                   <h1 className="text-2xl font-semibold my-1 pl-4">14H00 A 17H00</h1>
                   <ul className="pl-10">
                       <li> - Pratique sur modèles réelles</li>
                       <li> - Bilan du massage</li>
              ...
              <div className="my-3 py-3">
                   ...
                   <h1 className="text-2xl font-semibold my-1 pl-4">14H00 A 17H00</h1>
                   <ul className="pl-10">
                       <li> - Pratique massage complet</li>
